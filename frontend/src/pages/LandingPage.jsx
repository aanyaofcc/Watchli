...
export function LandingPage() {
  return (
    <div className="homepage-shell min-h-screen text-slate-900">
      ...
      <div className="aurora-orb right-[-60px] top-36 h-72 w-72 bg-blue-300/28" />
      <div className="aurora-orb bottom-24 left-1/2 h-56 w-56 -translate-x-1/2 bg-cyan-200/20" />
      ...
      <header className="relative z-10 mx-auto flex max-w-7xl items-center justify-between px-6 py-6">
        ...
        <div className="flex items-center gap-3">
          <Link
            to="/login"
            className="homepage-button-secondary rounded-full px-4 py-2 text-sm font-medium transition"
          >
            Log In
          </Link>
          <Link
      ...
      <main className="relative z-10">
        ...
        <section className="mx-auto grid max-w-7xl gap-12 px-6 pb-24 pt-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div>
            ...
            <h1 className="display-font mt-8 max-w-4xl text-5xl font-bold leading-[0.95] tracking-tight text-slate-900 sm:text-6xl lg:text-7xl">
              Track product prices before everyone else notices.
            </h1>
            ...
            <div className="mt-10 grid gap-4 sm:grid-cols-3">
              {[
                ...
                <div key={title} className="homepage-panel-soft rounded-3xl p-4">
          ...
          <div className="relative">
            <div className="homepage-panel rounded-[34px] p-5">
        ...
        <section id="how-it-works" className="mx-auto max-w-7xl px-6 py-10">
          <div className="mb-8 max-w-2xl">
            <p className="text-sm uppercase tracking-[0.24em] text-sky-700">How it works</p>
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            {steps.map((step, index) => (
              <div key={step.title} className="homepage-panel rounded-[30px] p-6">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-sky-200 to-blue-200 text-lg font-bold text-sky-900">
                  {index + 1}
                </div>
        ...
        <section className="mx-auto max-w-7xl px-6 py-12">
          <div className="grid gap-6 lg:grid-cols-3">
            {features.map(({ icon: Icon, title, body }) => (
              <div key={title} className="homepage-panel-soft rounded-[30px] p-6">
        ...
        <section id="pricing" className="mx-auto max-w-7xl px-6 py-12 pb-24">
          <div className="mb-8 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              <p className="text-sm uppercase tracking-[0.24em] text-sky-700">Pricing preview</p>
              <h2 className="display-font mt-3 text-4xl font-bold text-slate-900">
            ...
            {plans.map((plan, index) => (
              <div
                ...
                className={`rounded-[32px] p-[1px] ${
                  index === 0
                    ? "bg-gradient-to-br from-sky-300/40 via-white/30 to-white/20"
                    : "bg-gradient-to-br from-white/30 to-white/16"
                }`}
              >
                <div className="homepage-panel h-full rounded-[31px] p-8">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <p className="text-sm uppercase tracking-[0.2em] text-slate-600">
                        {plan.name}
                      </p>
                      <h3 className="display-font mt-3 text-4xl font-bold text-slate-900">
                        {plan.price}
                      </h3>
                  ...
                  <div className="mt-8 space-y-3">
                    {plan.features.map((feature) => (
                      <div
                        key={feature}
                        className="rounded-2xl border border-slate-300/40 bg-white/50 px-4 py-3 text-sm text-slate-700"
                      >
                        {feature}
                      </div>
                    ))}
                    ...
                    <Link
                      ...
                      className={`inline-flex items-center gap-2 rounded-full px-5 py-3 text-sm font-medium transition ${
                        index === 0
                          ...
                          : "glow-button bg-gradient-to-r from-[#35506b] via-[#3f6385] to-[#4d7596] text-white hover:scale-[1.01] hover:from-[#2f485f] hover:via-[#395a78] hover:to-[#456b8c]"
                      }`}
                    >
        ...
        <footer className="mx-auto max-w-7xl border-t border-slate-300/60 px-6 py-8 text-sm text-slate-600">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <p>
              ...
              <a className="text-sky-700 hover:text-slate-900" href="mailto:contactwatchli@gmail.com">
