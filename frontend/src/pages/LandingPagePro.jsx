    ...
    <div className="homepage-shell min-h-screen text-slate-900">
      ...
      <header className="relative z-10 mx-auto flex max-w-7xl items-center justify-between px-6 py-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            to="/signup"
            className="glow-button rounded-full bg-gradient-to-r from-[#7b4d36] via-[#8d5b40] to-[#a06b49] px-5 py-2.5 text-sm font-semibold text-white transition hover:scale-[1.02] hover:from-[#6e4531] hover:via-[#7f543d] hover:to-[#936345]"
          >
            Start Watching
          </Link>
        </div>
      ...
      <main className="relative z-10">
        ...
        <section id="product-preview" className="mx-auto max-w-7xl px-6 pb-12 sm:pb-16">
          ...
          <div className="homepage-panel rounded-[34px] p-4 sm:p-5">
            <div className="rounded-[28px] border border-white/10 bg-[linear-gradient(180deg,rgba(41,34,29,0.96),rgba(29,24,21,0.92))] p-5 sm:p-6">
              <div className="flex items-center justify-between border-b border-white/8 pb-4">
                ...
                <div className="rounded-full border border-[#d5b08d]/18 bg-[#b5835a]/12 px-3 py-1 text-xs font-medium text-[#f0dfcf]">
              ...
              <div className="mt-6 grid gap-4 xl:grid-cols-[240px_minmax(0,1fr)]">
                <div className="rounded-[28px] border border-white/10 bg-white/[0.03] p-4">
                  ...
                  <div className="mt-5 space-y-2 text-sm text-slate-300">
                    {["Dashboard", "Watched pages", "History", "Notifications", "Billing"].map(
                      (item, index) => (
                        <div
                          key={item}
                          className={`rounded-2xl px-3 py-2 ${
                            index === 0
                              ? "bg-[#b5835a]/12 text-white ring-1 ring-[#d5b08d]/18"
                              : "bg-white/[0.03]"
                          }`}
                        >
                          {item}
                  ...
                  <div className="grid gap-4 md:grid-cols-[1.2fr_0.8fr]">
                    <div className="rounded-[28px] border border-white/10 bg-white/[0.03] p-5">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#b5835a]/12 ring-1 ring-[#d5b08d]/18">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="rounded-[28px] border border-white/10 bg-white/[0.03] p-5">
                        <div className="flex items-center gap-3">
                          <div className="rounded-2xl bg-[#b5835a]/12 p-3">
                            <LineChart className="h-5 w-5 text-[#f0dfcf]" />
                          </div>
                          <div>
                      ...
                      <div className="rounded-[28px] border border-white/10 bg-white/[0.03] p-5">
                        <div className="flex items-center gap-3">
                          <div className="rounded-2xl bg-[#b5835a]/12 p-3">
                            <ScanSearch className="h-5 w-5 text-[#f0dfcf]" />
                          </div>
                          <div>
        ...
        <section className="mx-auto max-w-7xl px-6 pb-20">
          <div className="grid gap-8 rounded-[32px] border border-[#d9c6b7] bg-white/82 p-6 shadow-[0_22px_60px_rgba(59,43,32,0.08)] backdrop-blur md:p-8 lg:grid-cols-[0.9fr_1.1fr]">
            <div>
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#ead7c7] ring-1 ring-[#dcc0a6]">
        ...
        <footer className="hidden mx-auto max-w-7xl border-t border-slate-300/60 px-6 py-8 text-sm text-slate-600">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <p>
              ...
              <a className="text-[#7b4d36] hover:text-slate-900" href="mailto:contactwatchli@gmail.com">
                contactwatchli@gmail.com
              </a>
            </p>
